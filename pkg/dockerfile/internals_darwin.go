...
// parseChownFlag provides Darwin/macOS implementation for chown flag parsing
func parseChownFlag(ctx context.Context, builder interface{}, state interface{}, chown, ctrRootPath string, identityMapping user.IdentityMapping) (identity, error) {
...
// identity represents user identity with UID and GID
